...
"""
Helper file to build ia_ultralytics Docs reference section. Recursively walks through ia_ultralytics dir and builds an MkDocs
...
from ia_ultralytics.utils import ROOT
...
def create_markdown(py_filepath, module_path, classes, functions):
    ...
    url = f'https://github.com/ia_ultralytics/ia_ultralytics/blob/main/{module_path}.py'
    title_content = (f'# Reference for `{module_path}.py`\n\n'
                     f'!!! note\n\n'
                     f'    Full source code for this file is available at [{url}]({url}). Help us fix any issues you see by submitting a [Pull Request](https://docs.ia_ultralytics.com/help/contributing/) 🛠️. Thank you 🙏!\n\n')
        ...
        for file in files:
            if file.endswith('.py'):
                ...
                if classes or functions:
                    ...
                    module_path = f"ia_ultralytics.{py_filepath_rel.with_suffix('').as_posix().replace('/', '.')}"
