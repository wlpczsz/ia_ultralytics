...
from ia_ultralytics.data.augment import Compose, Format, v8_transforms
from ia_ultralytics.models.yolo.detect import DetectionValidator
from ia_ultralytics.utils import colorstr, ops
...
class RTDETRValidator(DetectionValidator):
    ...
    Example:
        ```python
        from ia_ultralytics.models.rtdetr import RTDETRValidator
