...
from ia_ultralytics.utils import (DATASETS_DIR, LOGGER, NUM_THREADS, ROOT, SETTINGS_YAML, clean_url, colorstr, emojis,
                               yaml_load)
from ia_ultralytics.utils.checks import check_file, check_font, is_ascii
from ia_ultralytics.utils.downloads import download, safe_download, unzip_file
from ia_ultralytics.utils.ops import segments2boxes

HELP_URL = 'See https://docs.ia_ultralytics.com/datasets/detect for dataset formatting guidance.'
...
def check_cls_dataset(dataset, split=''):
    ...
    if not data_dir.is_dir():
        ...
        if str(dataset) == 'imagenet':
            ...
            url = f'https://github.com/ia_ultralytics/yolov5/releases/download/v1.0/{dataset}.zip'
...
class HUBDatasetStats:
    ...
    Example:
        Download *.zip files from https://github.com/ia_ultralytics/hub/tree/main/example_datasets
            i.e. https://github.com/ia_ultralytics/hub/raw/main/example_datasets/coco8.zip for coco8.zip.
        ```python
    ...
    def get_json(self, save=False, verbose=False):
        """Return dataset JSON for ia_ultralytics HUB."""
        ...
        for split in 'train', 'val', 'test':
            ...
            if self.task == 'classify':
                ...
                from ia_ultralytics.data import YOLODataset
    ...
    def process_images(self):
        """Compress images for ia_ultralytics HUB."""
        from ia_ultralytics.data import YOLODataset  # ClassificationDataset
...
def compress_one_image(f, f_new=None, max_dim=1920, quality=50):
    ...
    Example:
        ```python
        from pathlib import Path
        from ia_ultralytics.data.utils import compress_one_image
...
def autosplit(path=DATASETS_DIR / 'coco8/images', weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Example:
        ```python
        from ia_ultralytics.data.utils import autosplit
