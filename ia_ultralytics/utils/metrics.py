...
from ia_ultralytics.utils import LOGGER, SimpleClass, TryExcept, plt_settings
...
def smooth_BCE(eps=0.1):  # https://github.com/ia_ultralytics/yolov3/issues/238#issuecomment-598028441
